...
createGRPCServer(){
    ...
    local app_base="$2"
    local app_name="$3"
    mkdir -p "${app_root}/grpc/server/helloworld/pb"
    ...
    cp -f "${CUR}/project_template/grpc/server/helloworld/pb/helloworld.pb.go.tpl" "${app_root}/grpc/server/helloworld/pb/helloworld.pb.go"
    cp -f "${CUR}/project_template/grpc/server/helloworld/pb/helloworld_grpc.pb.go.tpl" "${app_root}/grpc/server/helloworld/pb/helloworld_grpc.pb.go"
